...
@RestController
public class IoTDeviceInterfaceController {

    /**
     * IoT Device Interface with GET Method
     */
    @GetMapping("/IoTDevice/test")
     ...
     * IoT Device Interface with GET Method
     */
    @GetMapping("/IoTDevice/GET/input")
     ...
     */
    @PostMapping("/IoTDevice/POST/input")
    ...
    @GetMapping("/IoTDevice/output")
    public Object DeviceResponse() throws IOException {
        ...
        try {
            ...
            while (cursor.hasNext()) {
                ...
                iotDevice.setMessage(cursor.next().toString());
                    System.out.println(iotDevice.getMessage());
